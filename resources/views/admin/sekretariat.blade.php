...
<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
        <div>
            ...
            <h1 class="text-3xl font-extrabold text-slate-900 tracking-tight">Antrean Sekretariat</h1>
            <p class="text-sm text-slate-500 mt-1">Mengelola verifikasi awal kelengkapan dokumen pemohon.</p>
        </div>
    </div>
    ...
    <div class="glass-panel rounded-2xl overflow-hidden mb-10">
        <div class="px-6 py-4 border-b border-slate-200 bg-slate-50 flex justify-between items-center">
            <h3 class="font-bold text-slate-800 text-base">Antrean Pemeriksaan Awal ({{ count($queues) }})</h3>
        </div>
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="px-6 py-12 text-center text-xs text-slate-400">
                                Antrean kosong. Semua permohonan telah diperiksa awal.
                            </td>
                        </tr>
                    @endforelse
                </tbody>
