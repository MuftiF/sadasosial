...
<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
        <div>
            <span class="inline-flex items-center rounded-md px-2 py-0.5 text-xs font-bold bg-emerald-500/10 text-emerald-600 ring-1 ring-emerald-500/20 mb-2">
                PETUGAS / KEPALA DINAS SOSIAL
            </span>
            <h1 class="text-3xl font-extrabold text-slate-900 tracking-tight">Antrean Kepala Dinas</h1>
            <p class="text-sm text-slate-500 mt-1">Mengurus persetujuan akhir (TTE / Tanda Tangan Elektronik) dokumen perizinan resmi.</p>
        </div>
    </div>
    ...
    <div class="glass-panel rounded-2xl overflow-hidden mb-10">
        <div class="px-6 py-4 border-b border-slate-200 bg-slate-50 flex justify-between items-center">
            <h3 class="font-bold text-slate-800 text-base">Antrean Persetujuan Akhir Kepala Dinas ({{ count($queues) }})</h3>
        </div>
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="px-6 py-12 text-center text-xs text-slate-400">
                                Antrean kosong. Semua rekomendasi akhir telah disahkan.
                            </td>
                        </tr>
                    @endforelse
                </tbody>
