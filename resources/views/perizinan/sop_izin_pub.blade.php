...
@section('title', 'SOP Izin PUB - SADA SOSIAL')
...
<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div>
                <span class="inline-flex items-center rounded-full bg-emerald-100 px-3 py-1 text-xs font-semibold text-emerald-800 mb-2">
                    SOP Resmi - Penerbitan Izin PUB (Dinas DPMPTSP)
                </span>
                <h1 class="text-3xl font-extrabold text-slate-900 tracking-tight">SOP Penerbitan Izin PUB</h1>
                <p class="text-sm text-slate-500 mt-1">
                    Panduan alur resmi penerbitan Surat Keputusan Izin Pengumpulan Uang dan Barang (PUB) oleh Kepala Dinas DPMPTSP berdasarkan pemeriksaan kelengkapan berkas dan rekomendasi perangkat daerah teknis.
                </p>
            </div>
    ...
    <div class="glass-panel rounded-3xl p-6 sm:p-8 border border-slate-200 bg-white mb-10 shadow-sm">
        <h2 class="text-xl font-bold text-slate-900 mb-6 flex items-center gap-2">
            ...
            Visual Diagram Alur Izin PUB oleh DPMPTSP (9 Tahapan)
        </h2>
        ...
        <div class="relative border-l-2 border-emerald-200 ml-4 sm:ml-6 space-y-6 pl-6 sm:pl-8 py-2">
            ...
            <div class="relative group">
                ...
                <div class="bg-slate-50 p-5 rounded-2xl border border-slate-200/80 hover:border-emerald-300 transition space-y-2">
                    ...
                    <p class="text-xs text-slate-600 leading-relaxed font-normal">
                        Pemohon melakukan pendaftaran akun pemohon pada aplikasi SADA SOSIAL.
                    ...
                    <div class="text-[11px] text-emerald-750 font-bold mt-1">
                        ➡️ Output: Akun pemohon aktif untuk login.
                    </div>
                </div>
            </div>
            ...
            <div class="relative group">
                ...
                <div class="bg-slate-50 p-5 rounded-2xl border border-slate-200/80 hover:border-emerald-300 transition space-y-2">
                    ...
                    <h3 class="text-base font-bold text-slate-900">Melakukan Permohonan &amp; Mengunggah Dokumen Persyaratan</h3>
                    <p class="text-xs text-slate-600 leading-relaxed font-normal">
                        Pemohon mengisi data permohonan dan mengunggah berkas elektronik persyaratan:
                    </p>
                    <ul class="list-disc pl-5 text-xs text-slate-505 space-y-1">
                        <li>Surat Keterangan Baik Pengurus dari Kepolisian</li>
                        <li>Surat Keterangan Domisili Yayasan/Lembaga</li>
                        ...
                        <li>Scan Surat Rekomendasi dari Dinas Sosial Kabupaten/Kota setempat</li>
                        <li>Akta Notaris Pendirian &amp; SK Kemenkumham</li>
                        <li>Scan Surat Tanda Pendaftaran LKS (STP/STPU)</li>
                    </ul>
                    <div class="text-[11px] text-emerald-750 font-bold mt-1">
                        ➡️ Output: Berkas terupload di aplikasi.
                    </div>
                </div>
            </div>
            ...
            <div class="relative group">
                ...
                <div class="bg-slate-50 p-5 rounded-2xl border border-slate-200/80 hover:border-emerald-300 transition space-y-2">
                    ...
                    <h3 class="text-base font-bold text-slate-900">Pemeriksaan Kelengkapan &amp; Kebenaran Dokumen</h3>
                    <p class="text-xs text-slate-600 leading-relaxed font-normal">
                        Sekretariat meneliti kelengkapan administrasi berkas izin PUB yang diajukan.
                    </p>
                    ...
                    <div class="text-[11px] text-emerald-750 font-bold mt-1">
                        ➡️ Output: Berkas dinyatakan benar dan lengkap.
                    </div>
                </div>
            </div>
            ...
            <div class="relative group">
                ...
                <div class="bg-slate-50 p-5 rounded-2xl border border-slate-200/80 hover:border-emerald-300 transition space-y-2">
                    ...
                    <p class="text-xs text-slate-600 leading-relaxed font-normal">
                        Petugas teknis melakukan survei ke lokasi lapangan untuk memverifikasi kebenaran fisik lembaga pengusul izin.
                    </p>
                    <div class="p-3 bg-white rounded-xl border border-slate-200 text-xs">
                        <span class="font-bold text-slate-700 uppercase tracking-wide block mb-1">Decision Point:</span>
                        <ul class="list-none space-y-1 pl-1">
                            <li class="flex items-center gap-1.5"><span class="text-emerald-500">✔️ Ya:</span> Lapangan sesuai dengan data permohonan, lanjut ke pembuatan berita acara.</li>
            ...
            <div class="relative group">
                ...
                <div class="bg-slate-50 p-5 rounded-2xl border border-slate-200/80 hover:border-emerald-300 transition space-y-2">
                    ...
                    <p class="text-xs text-slate-600 leading-relaxed font-normal">
                        Petugas menyusun Berita Acara Pemeriksaan (BAP) dan menyusun draf rekomendasi persetujuan atau penolakan izin PUB.
                    </p>
                    <div class="text-[11px] text-emerald-750 font-bold mt-1">
                        ➡️ Output: Rekomendasi penerbitan izin.
                    </div>
                </div>
            </div>
            ...
            <div class="relative group">
                ...
                <div class="bg-slate-50 p-5 rounded-2xl border border-slate-200/80 hover:border-emerald-300 transition space-y-2">
                    ...
                    <p class="text-xs text-slate-600 leading-relaxed font-normal">
                        Melakukan verifikasi berkas izin digital di sistem berdasarkan rekomendasi teknis yang diajukan oleh tim pemeriksa sebelum diajukan ke Kepala Dinas DPMPTSP.
                    </p>
                    <div class="text-[11px] text-emerald-750 font-bold mt-1">
                        ➡️ Output: Dokumen izin terverifikasi di sistem.
                    </div>
                </div>
            </div>
            ...
            <div class="relative group">
                ...
                <div class="bg-slate-50 p-5 rounded-2xl border border-slate-200/80 hover:border-emerald-300 transition space-y-2">
                    ...
                    <h3 class="text-base font-bold text-slate-900">Persetujuan Akhir &amp; Tanda Tangan Elektronik (TTE) Kadis DPMPTSP</h3>
                    <p class="text-xs text-slate-600 leading-relaxed font-normal">
                        Kepala Dinas DPMPTSP selaku dinas perizinan terpadu membubuhkan Tanda Tangan Elektronik (TTE) sah pada dokumen Surat Keputusan Izin PUB yang disetujui.
                    </p>
                    <div class="text-[11px] text-emerald-750 font-bold mt-1">
                        ➡️ Output: Persetujuan elektronik / Surat Keputusan Izin dengan TTE sah.
                    </div>
                </div>
            </div>
            ...
            <div class="relative group">
                ...
                <div class="bg-slate-50 p-5 rounded-2xl border border-slate-200/80 hover:border-emerald-300 transition space-y-2">
                    ...
                    <h3 class="text-base font-bold text-slate-900">Pencetakan Dokumen Surat Keputusan Izin PUB</h3>
                    <p class="text-xs text-slate-600 leading-relaxed font-normal">
                        Pemohon dapat mengunduh lembar fisik Surat Keputusan (SK) Izin PUB digital berformat PDF yang telah dilengkapi kode verifikasi digital, lalu mencetaknya secara mandiri.
                    </p>
                    <div class="text-[11px] text-emerald-750 font-bold mt-1">
                        ➡️ Output: Lembar fisik Surat Keputusan Izin PUB tercetak.
                    </div>
                </div>
            </div>
            ...
            <div class="relative group">
                ...
                <div class="bg-emerald-50/70 p-5 rounded-2xl border border-emerald-200 hover:border-emerald-400 transition space-y-2">
                    ...
                    <h3 class="text-base font-bold text-slate-900">Pengarsipan Dokumen Izin secara Elektronik</h3>
                    <p class="text-xs text-slate-600 leading-relaxed font-normal">
                        Sekretariat mencatat dan mengarsipkan arsip digital permohonan dan dokumen SK Izin yang terbit ke dalam database pangkalan data SADA SOSIAL.
                    </p>
                    <div class="text-[11px] text-emerald-800 font-bold mt-1">
                        ➡️ Output: Dokumen perizinan tersimpan / di-backup via aplikasi secara aman.
                    </div>
                </div>
            </div>
    ...
    <div class="glass-panel rounded-3xl p-6 sm:p-8 border border-slate-200 bg-white shadow-sm overflow-hidden">
        <h2 class="text-xl font-bold text-slate-900 mb-4">Tabel Mutu Baku &amp; SLA SOP Izin PUB</h2>
            ...
            <table class="w-full text-left text-xs border-collapse">
                ...
                <tbody class="divide-y divide-slate-200 text-slate-700 font-medium">
                    ...
                    <tr>
                        ...
                        <td class="p-3 border-r border-slate-200">Pemohon</td>
                        <td class="p-3 border-r border-slate-200 text-slate-500">
                            Surat Keterangan Baik Pengurus (Kepolisian), Domisili Yayasan, Pernyataan Bebas Terorisme/Radikalisme, Scan Rekom Dinsos Kab/Kota, Akta Notaris &amp; SK Kemenkumham, Scan STP/STPU
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="p-3 border-r border-slate-200">Kepala Dinas DPMPTSP</td>
                        <td class="p-3 border-r border-slate-200 text-slate-500">Laptop / Komputer, Jaringan internet</td>
                        <td class="p-3 text-center font-bold border-r border-slate-200">15 Menit</td>
                ...
                <tfoot>
                    <tr class="bg-emerald-50 font-bold text-emerald-900 border-t-2 border-emerald-300">
                        ...
                        <td class="p-3">Sesuai SOP Resmi Dinas DPMPTSP</td>
                    </tr>
                </tfoot>
            </table>
        </div>
